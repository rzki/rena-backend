<div>
    <div class="main py-4">
        <div class="pagetitle ps-3 fw-bold">
            <h1 class="mb-3 h2 text-capitalize"><strong>{{ __('Edit Kode QR') }}</strong></h1>
        </div>
        <div class="row">
                                ...
                                <div class="col">
                                    <form wire:submit='update'>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="last_calibrated_at" class="form-label">{{ __('Kalibrasi Terakhir') }}</label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="location" class="form-label">{{ __('Hasil') }}</label>
                                                    <select name="location" id="location" class="form-control" wire:model='location'>
                                                        <option value="">{{ __('Pilih salah satu') }}</option>
                                                        <option value="Tidak Laik Pakai">{{ __('Tidak Laik Pakai') }}</option>
